...
namespace ARM.Sync
{
    public class Downloading
    {
        ...
        {
            List<Users> u = Users.ListOnline("SELECT * FROM users WHERE companyID ='"+Helper.CompanyID +"'");
            AdvancedForm._Form1.FeedBack("Downloading Users ... " + u.Count);
            foreach (var h in u)
            {
                ...
                {
                    AdvancedForm._Form1.FeedBack("Downloading ... " + h.Name.ToString());
                    Users m = new Users(h.Id, h.Name, h.Email, h.Contact, h.Address, h.City, h.State, h.Zip, h.Category, h.Ssn, h.Speciality, h.Gender, DateTime.Now.ToString("dd-MM-yyyy H:m:s"), true, Helper.CompanyID, h.Password, h.Image, h.Department, h.Active,h.Level);
					DBConnect.UpdateMySql(m, h.Id);
                    AdvancedForm._Form1.FeedBack("Downloading Updating .. " + h.Name.ToString());
                }
            }
            AdvancedForm._Form1.FeedBack("Downloading Users complete");
        }
        public static List<Customer> c = new List<Customer>();
        public static void Customers()
        {
            c = Customer.ListOnline("SELECT * FROM customer WHERE companyID ='" + Helper.CompanyID + "' ");
            AdvancedForm._Form1.FeedBack("Downloading Customer ... " + u.Count);
            foreach (var h in c)
            {
            ...
            AdvancedForm._Form1.FeedBack("Downloading Customer Complete");
        }
        public static List<Schedule> s = new List<Schedule>();
        public static void Schedules()
        {
            s = Schedule.ListOnline("SELECT * FROM schedule  WHERE companyID ='" + Helper.CompanyID + "'");
            AdvancedForm._Form1.FeedBack("Downloading Schedule ... " + u.Count);
            foreach (var h in s)
            {
                ...
                if (DBConnect.InsertPostgre(c) != "")
                {
                    AdvancedForm._Form1.FeedBack("Downloading ... " + h.Starts.ToString());
            ...
            AdvancedForm._Form1.FeedBack("Downloading Schedule Complete");
        }
        public static List<Product> i = new List<Product>();
        public static void Items()
        {
            i = Product.ListOnline("SELECT * FROM product WHERE companyID ='" + Helper.CompanyID + "' ");
            AdvancedForm._Form1.FeedBack("Downloading products ... " + u.Count);
            foreach (var h in i)
            {
            ...
            AdvancedForm._Form1.FeedBack("Downloading Item Complete");
        }
        public static List<Delivery> d = new List<Delivery>();
        public static void Deliverys()
        {
            d = Delivery.ListOnline("SELECT * FROM delivery WHERE companyID ='" + Helper.CompanyID + "' ");
            AdvancedForm._Form1.FeedBack("Downloading delivery ... " + d.Count);
            foreach (var h in d)
            {
                ...
                if (DBConnect.InsertPostgre(p) != "")
                {
                    AdvancedForm._Form1.FeedBack("Downloading ... " + h.Date.ToString());
            ...
            AdvancedForm._Form1.FeedBack("Downloading delivery Complete");
        }
        ...
        public static void Invoices()
        {
            ...
            AdvancedForm._Form1.FeedBack("Downloading invoice ... " + n.Count);
            foreach (var h in n)
            {
            ...
            AdvancedForm._Form1.FeedBack("Downloading invoice Complete");
        }
        public static List<CaseTransaction> t = new List<CaseTransaction>();
        public static void CaseTransactions()
        {
            t = CaseTransaction.ListOnline("SELECT * FROM transaction WHERE companyID ='" + Helper.CompanyID + "' ");
            AdvancedForm._Form1.FeedBack("Downloading transaction ... " + t.Count);
            foreach (var h in t)
            {
            ...
            AdvancedForm._Form1.FeedBack("Downloading transactions Complete");
        }
        ...
        public static void Payments()
        {
            ...
            AdvancedForm._Form1.FeedBack("Downloading payment ... " + t.Count);
            foreach (var h in k)
            {
            ...
            AdvancedForm._Form1.FeedBack("Downloading payment Complete");
        }
        ...
        public static void Order()
        {
            ...
            AdvancedForm._Form1.FeedBack("Downloading orders ... " + o.Count);
            foreach (var h in o)
            {
                ...
                if (DBConnect.InsertPostgre(p) != "")
                {
                    AdvancedForm._Form1.FeedBack("Downloading ... " + h.DispenseBy.ToString());
                    Orders u = new Orders(h.Id, h.No, h.CustomerID, h.UserID, h.OrderDate, h.OrderTime, h.OrderBy, h.DispenseDate, h.DispenseTime, h.DispenseBy, h.CustomerType, h.Diagnosis, h.Surgery, h.ClinicalDate, h.Instructions, h.Hospital, h.Home, h.PreopRm, h.PreopHome, h.PostopRm, h.RoomNo, h.SetupDate, h.DateNeeded, h.Facility, h.Clinic, h.Other, h.Notified, h.Authorised, h.Insurance, h.Contacted, h.Sent, h.Returned, h.DateSent, h.DateReturned, h.PractitionerID, DateTime.Now.ToString("dd-MM-yyyy H:m:s"), true, Helper.CompanyID);
					DBConnect.UpdateMySql(u, h.Id);
                    AdvancedForm._Form1.FeedBack("Updating .. " + h.DispenseBy.ToString());
                }
            }
            AdvancedForm._Form1.FeedBack("Downloading orders Complete");
        }
        public static List<Instruction> j = new List<Instruction>();
        public static void Instructions()
        {
            j = Instruction.ListOnline("SELECT * FROM instruction WHERE companyID ='" + Helper.CompanyID + "' ");
            AdvancedForm._Form1.FeedBack("Downloading instruction ... " + j.Count);
            foreach (var h in j)
            {
            ...
            AdvancedForm._Form1.FeedBack("Downloading instructions Complete");
        }
        ...
        public static void Follows()
        {
            ...
            AdvancedForm._Form1.FeedBack("Downloading follow ... " + a.Count);
            foreach (var h in a)
            {
                ...
                if (DBConnect.InsertPostgre(p) != "")
                {
                    AdvancedForm._Form1.FeedBack("Downloading ... " + h.Type.ToString());
            ...
            AdvancedForm._Form1.FeedBack("Downloading Follows Complete");
        }
        ...
        public static void ItemReviews()
        {
            ...
            AdvancedForm._Form1.FeedBack("Downloading product reviews... " + w.Count);
            foreach (var h in w)
            {
                ...
                if (DBConnect.InsertPostgre(p) != "")
                {
                    AdvancedForm._Form1.FeedBack("Downloading ... " + h.Details.ToString());
            ...
            AdvancedForm._Form1.FeedBack("Downloading product reviews Complete");
        }
        ...
        public static void ItemStatuses()
        {
            ...
            AdvancedForm._Form1.FeedBack("Downloading product status... " + q.Count);
            foreach (var h in q)
            {
            ...
            AdvancedForm._Form1.FeedBack("Downloading product status Complete");
        }

        public static List<Rate> b = new List<Rate>();
        public static void Rates()
        {
            b = Rate.ListOnline("SELECT * FROM rate WHERE companyID ='" + Helper.CompanyID + "' ");
            AdvancedForm._Form1.FeedBack("Downloading rates... " + b.Count);
            foreach (var h in b)
            {
                ...
                if (DBConnect.InsertPostgre(p) != "")
                {
                    AdvancedForm._Form1.FeedBack("Downloading ... " + h.Amount.ToString());
        ...
        {
            l = Account.ListOnline("SELECT * FROM account WHERE companyID ='" + Helper.CompanyID + "' ");
            AdvancedForm._Form1.FeedBack("Downloading Accounts... " + l.Count);
            foreach (var h in l)
            {
                ...
                if (DBConnect.InsertPostgre(p) != "")
                {
                    AdvancedForm._Form1.FeedBack("Downloading ... " + h.Bank.ToString());
            ...
            AdvancedForm._Form1.FeedBack("Downloading Accounts Complete");
        }
        public static List<Responsible> e = new List<Responsible>();
        public static void Repsonsibles()
        {
            e = Responsible.ListOnline("SELECT * FROM responsible WHERE companyID ='" + Helper.CompanyID + "' ");
            AdvancedForm._Form1.FeedBack("Downloading Responsible... " + e.Count);
            foreach (var h in e)
            {
                ...
                if (DBConnect.InsertPostgre(p) != "")
                {
                    AdvancedForm._Form1.FeedBack("Downloading ... " + h.Id.ToString());
            ...
            AdvancedForm._Form1.FeedBack("Downloading Patient  Complete");
        }
        public static List<Coverage> f = new List<Coverage>();
        public static void Coverages()
        {
            f = Coverage.ListOnline("SELECT * FROM coverage WHERE companyID ='" + Helper.CompanyID + "' ");
            AdvancedForm._Form1.FeedBack("Downloading Coverage... " + f.Count);
            foreach (var h in f)
            {
            ...
            AdvancedForm._Form1.FeedBack("Downloading Coverage Complete");
        }
        public static List<Vendor> v = new List<Vendor>();
        public static void Vendors()
        {
            v = Vendor.ListOnline("SELECT * FROM vendor WHERE companyID ='" + Helper.CompanyID + "' ");
            AdvancedForm._Form1.FeedBack("Downloading Vendor ... " + v.Count);
            foreach (var h in v)
            {
            ...
            AdvancedForm._Form1.FeedBack("Downloading Vendors Complete");
        }
