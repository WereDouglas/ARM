namespace ARM
{
	partial class CertificateReport
	{
		...
		private void InitializeComponent()
		{
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(CertificateReport));
			...
			this.toolStrip1.Size = new System.Drawing.Size(990, 50);
			...
			this.toolStripLabel1.Text = "Certificate";
			// 
			// tableLayoutPanel1
			// 
			...
			this.tableLayoutPanel1.Size = new System.Drawing.Size(1114, 758);
			...
			this.panel1.Size = new System.Drawing.Size(1108, 747);
			...
			reportDataSource1.Value = this.CertificateBindingSource;
			reportDataSource2.Name = "DataSet2";
			reportDataSource2.Value = this.CaseTransactionBindingSource;
			reportDataSource3.Name = "DataSet3";
			reportDataSource3.Value = this.ICD10BindingSource;
			this.reportViewer1.LocalReport.DataSources.Add(reportDataSource1);
			this.reportViewer1.LocalReport.DataSources.Add(reportDataSource2);
			this.reportViewer1.LocalReport.DataSources.Add(reportDataSource3);
			this.reportViewer1.LocalReport.ReportEmbeddedResource = "ARM.Reports.CertificateReport.rdlc";
			this.reportViewer1.Location = new System.Drawing.Point(0, 0);
			this.reportViewer1.Name = "reportViewer1";
			this.reportViewer1.Padding = new System.Windows.Forms.Padding(5);
			this.reportViewer1.ServerReport.BearerToken = null;
			this.reportViewer1.Size = new System.Drawing.Size(1108, 747);
			...
			// ICD10BindingSource
			// 
			this.ICD10BindingSource.DataSource = typeof(ARM.Model.ICD10);
			// 
			...
			this.ClientSize = new System.Drawing.Size(1114, 813);
			this.Controls.Add(this.tableLayoutPanel1);
			this.Controls.Add(this.toolStrip1);
			this.Font = new System.Drawing.Font("Trebuchet MS", 8.25F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
			this.Icon = ((System.Drawing.Icon)(resources.GetObject("$this.Icon")));
			this.Margin = new System.Windows.Forms.Padding(3, 4, 3, 4);
			this.Name = "CertificateReport";
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterParent;
			this.Text = "Certificate";
			this.WindowState = System.Windows.Forms.FormWindowState.Maximized;
			this.Load += new System.EventHandler(this.CertificateReport_Load);
