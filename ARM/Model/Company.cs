...
namespace ARM.Model
{
	public class Company
	{
		...
		public Company(string id, string name, string contact, string email, string npi, string address, string office, string providerID, string tin, string officePhone, string officeFax, string city, string zip, string state, string speciality, string created, string sync, string companyID, string image)
		{
			this.Id = id;
			this.Name = name;
		...
		public static List<Company> List()
		{
			...
			Reader = MySQL.Reading(Q);
			p = MySQL.DataReaderMapToList<Company>(Reader);
			return p;
		}
	}
}