...
namespace ARM.Model
{
	public class Practitioner
	{
		...
		public static List<Practitioner> List(string Q)
		{
			...
			p = MySQL.DataReaderMapToList<Practitioner>(Reader);
			return p;
