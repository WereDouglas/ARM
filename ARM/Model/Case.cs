...
namespace ARM.Model
{
    public class Case
    {
        ...
        public Case(string id, string date, string no, string provideNo, string coverageID, string customerID, string practitionerID, string practitionerType, string roleType, string type, string place, string information, string created, string reqStart, string reqEnd, string authStart, string authEnd, bool sync, string companyID)
        {
            this.Id = id;
            this.Date = date;
            this.No = no;
        ...
        static List<Case> p = new List<Case>();

       

        public static List<Case> List(string Q)
        {
            p.Clear();
            DBConnect.OpenConn();
        ...
        static List<Case> c = new List<Case>();
