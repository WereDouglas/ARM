...
namespace ARM.Model
{
    public class Users
    {
        ...
        public Users(string id, string name, string email, string contact, string address, string city, string state, string zip, string category, string gender, string created, bool sync, string password, string image)
        {
            this.Id = id;
            this.Name = name;
            this.Email = email;
