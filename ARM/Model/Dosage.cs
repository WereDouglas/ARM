...
namespace ARM.Model
{
    public class Dosage
    {
        ...
        public Dosage(string id, string serviceID, string customerID, string medication, string amount, string route, string freq, string starts, string dc, string details, string created, string sync, string companyID)
        {
            this.Id = id;
